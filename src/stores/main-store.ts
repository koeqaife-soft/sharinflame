...
const dialogs = {
  ...
  replies: defineAsyncComponent(() => import("src/components/posts/RepliesDialog.vue")),
  ...
  emailVerify: defineAsyncComponent(() => import("src/components/settings/security/EmailVerifyDialog.vue"))
} as const;
